			...
			<div id="bon-fee-post-body-content">
				...
				<?php if ( post_type_supports( $post_type, 'title' ) ) { ?>
					...
					<div id="bon-fee-titlewrap">
						 ...
						 */
						?>
						<input type="text" name="post_title" size="30" placeholder="<?php echo apply_filters( 'enter_title_here', __( 'Enter title here' ), $post ); ?>" value="<?php echo esc_attr( htmlspecialchars( $post->post_title ) ); ?>" id="title" autocomplete="off" />
