...
final class Theme_Fonts {
	...
	function get_google_fonts() {
		...
		if ( false === ( $google_fonts = get_transient( $this->google_transient ) ) ) {
		  // It wasn't there, so regenerate the data and save the transient
		   $api_key = bon_get_framework_option( 'bon_framework_google_api', 'AIzaSyBIluei6yjgNvocIeSargnbOZHfSxy_HTg');
