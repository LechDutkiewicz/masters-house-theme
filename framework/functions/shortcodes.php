...
function bon_theme_link_shortcode() {
	...
	return '<a class="theme-link" href="http://www.techsavvymarketers.com" title="Ecommerce solutions"><span>TechSavvy Marketers</span></a>';
}
...
function bon_entry_terms_shortcode( $attr ) {
	$attr = shortcode_atts( array( 'text' => __('Category:', 'bon'), 'exclude_child' => false, 'id' => get_the_ID(), 'limit' => -1, 'taxonomy' => 'post_tag', 'separator' => ', ', 'before' => '', 'after' => '' ), $attr );
	$termlists = '';
