...
function shandora_search_yearbuilt_field($value = array(), $class) {
    ...
    $o .= '<div class="row">';
        $o .= '<div class="column large-6">' . $form->form_dropdown('min_yearbuilt', $options1, $value['min_yearbuilt'], 'class="'.$class.'"') . '</div>';
        $o .= '<div class="column large-6">' . $form->form_dropdown('max_yearbuilt', $options2, $value['max_yearbuilt'], 'class="'.$class.'"') . '</div>';
    $o .= '</div>';
...
function shandora_search_lotsize_field($value = array(), $class) {
	...
	$o = '<label for="property_lotsize">'.__('Size', 'bon');
