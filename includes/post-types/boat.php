...
if( !function_exists( 'shandora_setup_boat_dealer_post_type') )  {
	...
	function shandora_setup_boat_dealer_post_type() {
		...
		$cpt->add_taxonomy("Boat Type", array( 'rewrite' => $boat_type_rewrite, 'label' => __('Boat Types','bon'), 'labels' => array('menu_name' => __('Boat Types','bon') ), 'hierarchical' => true ) );
		...
		$cpt->add_taxonomy("Boat Feature", array( 'rewrite' => $feature_rewrite, 'label' => __('Boat Features','bon'), 'labels' => array('menu_name' => __('Features','bon') ) ) );
