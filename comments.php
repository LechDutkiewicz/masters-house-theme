		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<div class="row collapse input-container">
				...
				<div class="column large-6 small-11 input-container-inner user">
					<input class="attached-input" type="text" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" placeholder="<?php _e( 'Full Name', 'bon' ); ?>"  size="22" tabindex="1" />
				</div>
			</div>
			...
			<div class="row collapse input-container">
				...
				<div class="column large-6 small-11 input-container-inner mail">
					<input class="attached-input" type="text" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" placeholder="<?php _e( 'Email Address', 'bon' ); ?>"  size="22" tabindex="2" />
				</div>
			</div>
			...
			<div class="row collapse textarea-container input-container" >
				...
				<div class="column large-11 small-11 input-container-inner pencil">
					<textarea name="comment" class="attached-input" id="comment" placeholder="<?php _e( 'Comment', 'bon' ); ?>" cols="58" rows="10" tabindex="4"></textarea>
				</div>
			</div>
