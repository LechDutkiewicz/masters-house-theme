...
if ( !empty( $agent_id ) ) {
	...
	<section class="listing-contact">
		<!-- since 1.3.6 -->
		<header>
			<h3><?php _e( 'Contact our representative', 'bon' ); ?></h3>
			<hr />
		</header>
		<div class="row entry-content">
			...
			<?php endif; ?>
			<?php
			if ( $show_contact_form == 'yes' ) :

				$col_class = 'large-6';

				if ( $show_agent_details == 'no' ) {
					$col_class = 'large-12';
				}
				?>
				<div class="column <?php echo $col_class; ?>">
